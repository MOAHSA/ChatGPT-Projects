...
class RecipeManager(tk.Tk):
    ...
    def search_all_recipes(self, *args):
        ...
        if found_results:
            for item in result_items:
                ...
                # Actions frame
                actions_frame = ttk.Frame(result_card)
                actions_frame.pack(fill=tk.X, padx=8, pady=5)
    ...
    def create_recipe_card(self, recipe_name, recipe_info):
        """Create a recipe card for the recipe list with a right-click context menu"""
        ...
        title_frame.pack(fill=tk.X, pady=5, padx=5)
        
        recipe_icon = ttk.Label(title_frame, text="🍲", font=("Segoe UI", 14))
        recipe_icon.pack(side=tk.LEFT, padx=(5, 5))
        ...
        # Make the card clickable for view action
