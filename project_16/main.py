...
class RecipeManager(tk.Tk):
    def __init__(self):
        ...
        # Configure colors - 2025 design-inspired color scheme
        self.primary_color = "#4361ee"       # Modern indigo blue
        self.secondary_color = "#3a0ca3"     # Deep purple for dimension
        self.bg_color = "#f8f9fa"            # Almost white background
        self.text_color = "#2b2d42"          # Dark blue-gray for text
        self.accent_color = "#f72585"        # Vibrant magenta accent
        self.card_bg = "#ffffff"             # Pure white for cards
        self.highlight_color = "#4cc9f0"     # Cyan for highlights
        self.category_header_bg = "#edf2fb"  # Very light periwinkle
        self.success_color = "#06d6a0"       # Mint green for success
        self.card_border = "#e9ecef"         # Lighter gray border
        self.muted_text = "#6c757d"          # Muted gray for secondary text
    ...
    def make_rounded(self, widget):
        ...
        # We can't actually make rounded corners in tk directly, but we can approximate the look
    ...
    def create_recipe_card(self, recipe_name, recipe_info):
        ...
        # Recipe title with icon - modern layout
        title_frame = ttk.Frame(card, style="Card.TFrame")
        title_frame.pack(fill=tk.X, pady=(5, 8), padx=5)
        
        recipe_icon = ttk.Label(title_frame, text="🍲", font=("Segoe UI", 16))
    ...
    def add_context_menu(self, widget, recipe_name, category=None):
        ...
        menu = tk.Menu(widget, tearoff=0, bg="white", fg=self.text_color, 
